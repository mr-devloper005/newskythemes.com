export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'newskythemes',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Newskythemes',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'newskythemes.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://newskythemes.com',
