...
export const taskPageVoices = {
  ...
  sbm: {
    eyebrow: 'The Library',
    headline: 'Curated resources arranged into browsable collections.',
    description: 'Browse tools, references, guides, and links organized by topic — each one reviewed and described before it enters the library.',
    filterLabel: 'Filter collection',
    secondaryNote: 'Curated resources need grouping and calm metadata.',
    chips: ['Collections', 'Resources', 'Tools', 'References'],
  },
  profile: {
    eyebrow: 'Curators',
    headline: 'Contributors and curators behind the library.',
    description: 'Discover the people who review, organize, and maintain the collections that keep the library useful.',
